...
public class CsharpUnityClientCodegen extends DefaultCodegen implements CodegenConfig {
    public static final String CLIENT_PACKAGE = "clientPackage";
    protected String packageName = "IO.Swagger";
    protected String packageVersion = "1.0.0";
    protected String clientPackage = "IO.Swagger.Client";
    protected String sourceFolder = "src" + File.separator + "main" + File.separator + "CsharpUnity";

    public CsharpUnityClientCodegen() {
        super();
        outputFolder = "generated-code" + File.separator + "CsharpUnity";
        modelTemplateFiles.put("model.mustache", ".cs");
        apiTemplateFiles.put("api.mustache", ".cs");
        embeddedTemplateDir = templateDir = "CsharpUnity";
    ...
    public String getHelp() {
        return "Generates a C# client library for Unity 5.3.1.";
    }
